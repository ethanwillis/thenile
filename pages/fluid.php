  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
            <h1>Welcome to the Nile!</h1>
            <p>The Nile is an exciting place on the internet where you can find all your products, and discover new ones.</p>
            <p><a class="btn btn-primary btn-large" href="../pages/products.php">Explore The Nile &raquo;</a></p>
          </div>
          <div class="row-fluid">
            <div class="span4">
              <h2>Music</h2>
              <p><img src="../assets/img/thenile/MusicLogo.jpg">
				 <br>
				 Do you love to listen to music? Then check out our wide selection of new and old albums. We have all of the classic and contemporary hits ready for you! </p>
              <p><a class="btn" href="../pages/products.php?cat=2">Find Music! &raquo;</a></p>
            </div><!--/span-->
            <div class="span4">
              <h2>Videos</h2>
              <p><img src="../assets/img/thenile/VideoLogo.jpg">
				 <br>
				 Did you miss the latest blockbuster? Do you want to find cult classics, epic trilogys, drama, comedies, etc.? Don't worry we got you covered! Click now to view our selection of movies!</p>
              <p><a class="btn" href="../pages/products.php?cat=4">Watch Movies! &raquo;</a></p>
            </div><!--/span-->
            <div class="span4">
              <h2>Books</h2>
              <p><img src="../assets/img/thenile/BooksLogo.jpg">
				 <br>
				 Bookworms look no further! We have every type of book to meet your needs, click below to browse our selection, buy, and start reading!</p>
              <p><a class="btn" href="../pages/products.php?cat=5">Read Books! &raquo;</a></p>
            </div><!--/span-->
          </div><!--/row-->
